      ...
      <Row>
        ...
        <Col xs={6} md={6}>
          <div className="market-google">
            <a href="https://play.google.com/store/apps/details?id=com.krooppa&hl=es_CO" target="_blank" rel="noopener noreferrer"><img className="markets-img" src={android} alt="play-store"/></a>
          </div>
        </Col>
      </Row>
      <Row>
